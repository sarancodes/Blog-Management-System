        ...
        <div class="row">
            <div class="box">
                ...
                <div class="col-lg-12 text-center">
                    ...
                    <p>The first thing in the morning</p>
                ...
                <div class="col-lg-12 text-center">
                    ...
                    <h2>Python Trends
                        <br>
                        <small>Jack Reacher</small>
                    </h2>
                    <p>The latest trending python librariers</p>
                    <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal2">Read</button>
                    <hr>
                </div>
                <div class="col-lg-12 text-center">
                    ...
                    <h2>Movie Review 
                        <br>
                        <small>Sebastian</small>
                    </h2>
                    <p>The newly released movie Doctor Strange</p>
                    <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal3">Read</button>
                    <hr>
                </div>
                <div class="col-lg-12 text-center">
                    <ul class="pager">
